...
def annotate(annotator, texts: list, lang: str = None) -> requests.Response:
    ...
    url = "http://{host}:{port}/{endpoint}".format(host=annotator, port=5000, endpoint=endpoint)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--annotator", required=True, choices=["deeppavlov", "floods", ], help="The Annotator API URL for which to run the tests.")
