...
class TestTwitterDagDefinition:
    ...
    def test_number_of_tasks(self, dag):
        ...
        assert n_tasks == self.EXPECTED_N_TASKS, "Wrong number of tasks, {0} expected, got {1}".format(self.EXPECTED_N_TASKS, n_tasks)
    ...
    @pytest.mark.parametrize("task, expected_upstream, expected_downstream", 
        [
            ...
            ("extract_tweets", ["push_collection_id", "push_filepaths", "is_deeppavlov_api_ready", "is_floods_api_ready"], ["transform_tweets"]), 
